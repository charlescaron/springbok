...
module.exports = {
    ...
    update: function(req, res) {
        currentResponse = res;
        var rawEnvironment = req.body;
        var converted = {name: rawEnvironment.name, description: rawEnvironment.description};
        Environment.findByIdAndUpdate(rawEnvironment._id, converted, processResponse);
    }
};
