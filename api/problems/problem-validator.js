...
var BAD_NAME = "The problem name must be an alphanumeric string between 1 and " + NAME_MAX_LENGTH + " characters";
var BAD_DESC = "The problem description cannot have more than " + DESC_MAX_LENGTH + " characters";
